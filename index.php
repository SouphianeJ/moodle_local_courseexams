...
$jsconfig = [
    ...
    'strings' => [
        ...
        'courseid_short' => get_string('courseidshort', 'local_courseexams'),
        'exams' => get_string('exams', 'local_courseexams'),
        'assignments' => get_string('assignments', 'local_courseexams'),
        'quizzes' => get_string('quizzes', 'local_courseexams'),
        'visiblecount' => get_string('visiblecount', 'local_courseexams'),
        'hiddencount' => get_string('hiddencount', 'local_courseexams'),
